...
$query = "select * from solicitacao soc  inner join cartoes car on car.idcartoes = soc.cod_cartao";
        ...
        <div class="table-cast" id="table-cast">
            <div>
                <div class="row line-hd" id="tb-hd">
                    ...
                    <div class="col">DATA DE DEVOLUÇÃO</div>
                    <div class="col">SITUAÇÃO</div>
                    <div class="col">N UNICO</div>
                </div>
                <?php
                  $cont = 0;
                     while($row_solicit = mysqli_fetch_assoc($data)){
                        ...
                        echo '<div class="col" id="situacao">R$ '.$row_solicit['valor'].'</div>';
                        echo '<div class="col" id="situacao">'.$row_solicit['data_devolucao'].'</div>';
                        echo '<div class="col" id="situacao">'.$row_solicit['situacao'].'</div>';
                        echo '<div class="col" id="situacao">'.$row_solicit['N_UNICO_SNK'].'</div>';
                        echo '</div> ';
                    }                 
                  ?>
            </div>
